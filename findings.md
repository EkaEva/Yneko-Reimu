...
- Recovery codes are still absent in v0.2.5, so the documented emergency fallback is external removal of `_yneko_reimu_totp_enabled` for the locked user until a dedicated recovery-code round is implemented.
