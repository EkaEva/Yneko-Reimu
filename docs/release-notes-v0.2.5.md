...
- 扩展 settings admin contract gate，保护设置分组结构和工具条开关归属。
...
- Extended the settings admin contract gate to protect the grouped settings layout and toolbar-setting placement.
