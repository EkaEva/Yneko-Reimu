...
<div class="post-wrapper">
	<div id="post-<?php the_ID(); ?>" <?php post_class( 'post-wrap ' . $side ); ?> data-aos="fade-up">
		...
		<div class="post-info">
			...
			<article class="post-article"><?php echo esc_html( yneko_reimu_excerpt( get_the_ID() ) ); ?></article>
		</div>
	</div>
</div>
