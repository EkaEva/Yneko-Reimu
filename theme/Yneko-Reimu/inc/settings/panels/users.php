...
function yneko_reimu_render_settings_users_panel( $review_badges ) {
	$context = yneko_reimu_settings_users_panel_context( $review_badges );
	?>
	<section class="yneko-reimu-settings-panel" data-yneko-settings-panel="users" hidden>
		...
		<table class="form-table" role="presentation">
			<?php yneko_reimu_render_settings_users_basic_row( $context['comment_upload'], $context['user_badges'], $context['avatar_frames'] ); ?>
			<?php yneko_reimu_render_settings_users_special_badges_row( $context['user_badges'], $context['avatar_frames'] ); ?>
			<?php yneko_reimu_render_settings_users_blocklist_row( $context['user_badges'] ); ?>
		</table>
		<?php yneko_reimu_render_settings_users_review_sections( $context['review_badges'] ); ?>
	</section>
	<?php
}

function yneko_reimu_settings_users_panel_context( $review_badges ) {
...
function yneko_reimu_render_settings_users_review_sections( $review_badges ) {
	?>
	...
	<tr>
		...
		<td>
			<div class="yneko-reimu-settings-subgrid yneko-reimu-settings-subgrid-2">
				<?php yneko_reimu_render_settings_users_badge_toggles( $user_badges, $avatar_frames ); ?>
				<?php yneko_reimu_render_settings_users_avatar_toggles( $comment_upload ); ?>
			</div>
...
function yneko_reimu_render_settings_users_badge_toggles( $user_badges, $avatar_frames ) {
	yneko_reimu_settings_field_open( '用户标签与头像框', 'User badges and avatar frames' );
	?>
...
function yneko_reimu_render_settings_users_avatar_toggles( $comment_upload ) {
	yneko_reimu_settings_field_open( '用户头像上传', 'User avatar uploads' );
	?>
