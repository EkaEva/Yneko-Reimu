...
function yneko_reimu_render_settings_music_panel( $settings, $player ) {
	...
	<section class="yneko-reimu-settings-panel" data-yneko-settings-panel="music" hidden>
		...
		<table class="form-table" role="presentation">
			<?php yneko_reimu_render_settings_music_provider_row( $player ); ?>
			<?php yneko_reimu_render_settings_music_behavior_row( $player ); ?>
			<?php yneko_reimu_render_settings_music_options_row( $player ); ?>
			<?php yneko_reimu_render_settings_music_meting_row( $player ); ?>
		</table>
		<?php yneko_reimu_render_settings_music_tracks( $settings ); ?>
	</section>
	<?php
}

function yneko_reimu_render_settings_music_provider_row( $player ) {
	?>
	<tr>
...
function yneko_reimu_render_settings_music_behavior_row( $player ) {
	?>
	<tr>
...
function yneko_reimu_render_settings_music_options_row( $player ) {
	?>
	<tr>
		...
		<td>
			<div class="yneko-reimu-settings-subgrid yneko-reimu-settings-subgrid-3">
				<?php yneko_reimu_render_settings_music_select( 'loop', '循环模式', 'Loop', $player['loop'], array( 'all', 'one', 'none' ) ); ?>
				<?php yneko_reimu_render_settings_music_select( 'order', '播放顺序', 'Order', $player['order'], array( 'list', 'random' ) ); ?>
				<?php yneko_reimu_render_settings_music_select( 'preload', '预加载', 'Preload', $player['preload'], array( 'metadata', 'none', 'auto' ) ); ?>
...
function yneko_reimu_render_settings_music_select( $key, $label_zh, $label_en, $value, $options ) {
	?>
	<label><?php yneko_reimu_admin_bilingual_label( $label_zh, $label_en ); ?>
		<select name="yneko_reimu_settings[player][<?php echo esc_attr( $key ); ?>]">
...
function yneko_reimu_render_settings_music_meting_row( $player ) {
	?>
	<tr>
...
function yneko_reimu_render_settings_music_tracks( $settings ) {
	?>
