...
const enTranslations = new Map(Object.entries({
  ...
  'Reimu 设置说明表格': 'Reimu settings table',
  'Reimu 代码窗口': 'Reimu code window',
  '文章引言卡片': 'Article intro card',
  '在这里写下文章的核心摘要，让读者先抓住这一页最重要的情绪与信息。': 'Write the core summary here so readers can quickly grasp the most important context.',
  '双栏说明区块': 'Two-column note section',
  '重点': 'Key point',
  '用于放置文章中的重点信息、更新说明或推荐阅读。': 'Use this for key information, update notes, or recommended reading.',
  '补充': 'Supplement',
  '用于放置上下文、链接或轻量的延伸解释。': 'Use this for context, links, or lightweight extra explanation.',
  '设置说明表格': 'Settings table',
  '用于整理设置项、默认值、说明和影响范围。': 'Use this to organize settings, defaults, notes, and impact scope.',
  '设置项': 'Setting',
  '默认值': 'Default',
  '说明': 'Description',
  '影响范围': 'Scope',
  '说明这个选项解决什么问题。': 'Describe what problem this option solves.',
  '仅在满足页面上下文时加载。': 'Loads only when the page context matches.',
  '说明推荐值和可选值。': 'Describe the recommended and optional values.',
  '影响前台展示，不改变历史内容。': 'Affects front-end display without changing historical content.',
  '代码窗口': 'Code window',
  '用于插入会在前台增强为 Reimu 代码窗口的原生代码块。': 'Insert a native code block that is enhanced into a Reimu code window on the front end.',
  '示例命令': 'Example command',
  'TIP 提示块': 'TIP notice',
  'INFO 说明块': 'INFO notice',
  'WARNING 警告块': 'WARNING notice',
  '用于插入主题化提示、说明或警告信息。': 'Insert a themed tip, information, or warning notice.',
  '在这里写下需要读者特别留意的说明。': 'Write the note readers should pay special attention to.',
  '技术笔记段落结构': 'Technical note section',
  '用于快速搭建包含摘要、提示、表格和代码窗口的说明型文章段落。': 'Quickly build a documentation-style section with a summary, notice, table, and code window.',
  '实现思路': 'Implementation idea',
  '先用一两句话说明问题、结论和适用范围。': 'Use one or two sentences to explain the problem, conclusion, and scope.',
  '说明块': 'Notice block',
