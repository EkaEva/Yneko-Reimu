...
const enTranslations = new Map(Object.entries({
  ...
  '启用严格复刻侧栏': 'Enable strict Reimu sidebar clone',
  '起始年份': 'Start year',
  '强调色': 'Accent color',
  ...
  '学习笔记': 'Study notes',
  '循环模式': 'Loop mode',
  '严格复刻时显示标签云小组件': 'Show tag-cloud widget in strict clone mode',
  '页脚': 'Footer',
  ...
  '保持参考站侧栏作者卡下方的 Reimu 标签云区域；不启用 WordPress 原生小工具。': 'Keep the Reimu tag-cloud area below the reference-site sidebar author card; do not enable native WordPress widgets.',
  ...
  '开启时隐藏 WordPress 小工具区，只保留 Reimu 作者卡、统计、社交和菜单。': 'When enabled, WordPress widget areas are hidden and only the Reimu author card, stats, social links, and menu remain.',
  ...
  '默认按 D-Sketon 演示站首页输出固定导航、语言入口、左侧个人卡和两个首页胶囊。': 'By default, output a fixed nav, language entry, left profile card, and two home capsules like D-Sketon’s demo site.',
  ...
  '用于 Reimu 扩展包的 CDN 前缀，默认与 upstream 演示站一致。': 'CDN prefix for Reimu extension packages. The default matches the upstream demo site.',
  '邮箱': 'Email',
