...
```bash
pwsh tools/package-theme.ps1 -Version v0.2.11
```
...
pwsh tools/package-theme.ps1 -OutputName Yneko-Reimu-v0.2.11.zip
...
推荐 tag 命名使用 `vX.Y.Z`，例如 `v0.2.11`。如果手动输入 `0.2.11`，打包脚本会自动补成 `v0.2.11`。
...
- [v0.2.11 发布说明](docs/release-notes-v0.2.11.md)
...
Current release notes: [v0.2.11](docs/release-notes-v0.2.11.md).
