...
pwsh tools/package-theme.ps1 -OutputName Yneko-Reimu-v0.2.3.zip
```

随后生成并上传：

```text
Yneko-Reimu-v0.2.3.zip
```
...
推荐 tag 命名使用 `vX.Y.Z`，例如 `v0.2.3`。如果手动输入 `0.2.3`，打包脚本会自动补成 `v0.2.3`。
...
Current release notes: [v0.2.3](docs/release-notes-v0.2.3.md).
