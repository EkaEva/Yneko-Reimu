...
```bash
pwsh tools/package-theme.ps1 -Version v0.2.10
```
...
pwsh tools/package-theme.ps1 -OutputName Yneko-Reimu-v0.2.10.zip
...
推荐 tag 命名使用 `vX.Y.Z`，例如 `v0.2.10`。如果手动输入 `0.2.10`，打包脚本会自动补成 `v0.2.10`。
...
- [v0.2.10 发布说明](docs/release-notes-v0.2.10.md)
...
Current release notes: [v0.2.10](docs/release-notes-v0.2.10.md).
