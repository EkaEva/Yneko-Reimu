...
```bash
pwsh tools/package-theme.ps1 -Version v0.2.17
```
...
pwsh tools/package-theme.ps1 -OutputName Yneko-Reimu-v0.2.17.zip
...
推荐 tag 命名使用 `vX.Y.Z`，例如 `v0.2.17`。如果手动输入 `0.2.17`，打包脚本会自动补成 `v0.2.17`。
