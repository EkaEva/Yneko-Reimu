...
```bash
pwsh tools/package-theme.ps1 -Version v0.2.7
```
...
pwsh tools/package-theme.ps1 -OutputName Yneko-Reimu-v0.2.7.zip
...
推荐 tag 命名使用 `vX.Y.Z`，例如 `v0.2.7`。如果手动输入 `0.2.7`，打包脚本会自动补成 `v0.2.7`。
...
- [v0.2.7 发布说明](docs/release-notes-v0.2.7.md)
...
Current release notes: [v0.2.7](docs/release-notes-v0.2.7.md).
