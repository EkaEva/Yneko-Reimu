...
```bash
pwsh tools/package-theme.ps1 -Version v0.1.14
```
...
pwsh tools/package-theme.ps1 -OutputName Yneko-Reimu-v0.1.14.zip
```

随后生成并上传：

```text
Yneko-Reimu-v0.1.14.zip
```
...
推荐 tag 命名使用 `vX.Y.Z`，例如 `v0.1.14`。如果手动输入 `0.1.14`，打包脚本会自动补成 `v0.1.14`。
